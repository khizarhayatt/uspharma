<div class="d-flex justify-content-between flex-xxl-row flex-column  mt-md-0 mt-sm-3">
    <div class="custom-margin-filter ">
        ...
        placeholder="Pick date range" id="transactionDateFilter" />
    </div>
                    ...
                    <div class="p-5">
                        <div class="mb-5">
                            ...
                            {{ Form::select(
                                ...
                                ['class' => 'form-control form-control-solid form-select','placeholder'=>'All', 'data-control' => 'select2', 'id' => 'trPaymentMehtod'],
                            ) }}
                        </div>
                        <div class="mb-5">
